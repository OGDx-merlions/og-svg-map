...
function runBaseTests() {
  og_svg_map_1 = document.getElementById('og_svg_map_1');

  suite('Base Automation Tests for og-svg-map', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('og-svg-map fixture is created', function() {
      assert.isTrue(document.getElementById('og_svg_map_1') !== null);
    });
